...
public class Adapter extends RecyclerView.Adapter<Adapter.NewsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NewsViewHolder viewHolder, int i) {
        viewHolder.initData(i, context);
        viewHolder.setupClickListener(i,context);
    }
    ...
    public static class NewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void initData(int position, Context context) {
        ...
        public void setupClickListener(final int position, final Context context){
